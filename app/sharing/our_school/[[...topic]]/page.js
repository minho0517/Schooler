...
import styles from './ourSchool.module.css';
...
export default function Page({params}) {
    ...
    const apiUrl = `/api/sharing/list/ourSchool?topic=${topic === undefined ? "전체" : topic}`;
    const queryKey = ['get-sharingList-ourSchool', topic];

    const { data, fetchNextPage, isFetchingNextPage, hasNextPage, status } = useGetQuery({ apiUrl, queryKey });
